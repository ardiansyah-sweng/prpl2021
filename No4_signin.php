...
<html lang="en">
  ...
  <style>
  /* seting pada program Sign-in */
    * {
      padding: 0;
      margin: 0;
      box-sizing: border-box;
    }
    /* seting pada body program Sign-in */
    body {
      background: rgb(221, 218, 218);
    }
    /* seting pada classs row program Sign-in */
    .row {
      box-shadow: 12px 12px 22px grey;
    }
    /* seting pada span program Sign-in */
    span {
      color: darkorange;
    }
      /* seting pada class log program Sign-in */
    .log {
      background-color: rgb(90, 77, 77);
    }
      /* seting pada text h1 program Sign-in */
    h1 {
      font-size: 45px;
      color: white;
      font-weight: 800;
    }
      /* seting pada class form-control program Sign-in */
    .form-control {
      ...
      /* seting pada class from-control untuk fokus*/
    .form-control:focus {
      background-color: rgb(65, 56, 56);
      outline: none;
      color: white;
    }
    .btn1 {   /* seting class btn1 program Sign-in */
      background: orange;
      color: white;
      outline: none;
      border: none;
      ...
      /* seting text program Sign-in pada "a" */
    a {
      color: yellow;
      cursor: pointer;
      padding: 10px;
      ...
      <div class="container py-5 text-center text-white">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-8 py-5 log">
            <div class="row1">
            <!-- menampilkan tulisan pada pengunjung web -->
              <div class="col-lg-7 mx-auto">
                <h1><span>Member</span> login</h1>
                <p>Selamat datang, Silahkan login</p>

                <form class="pt-4" action="No4_conn_signin.php" method="POST">
                <?php if(isset($_GET['error'])){ ?><p class="error"> <?php echo $_GET['error'] ?> </p><?php } ?>                    
                  ...
                  <br />
                  <small
                    >Belum punya akun ?<span><a href="No4_signup.php">Resister Sekarang </a></span></small
                  >
                </form>
              </div>
            </div>
