...
<html lang="en">
  ...
  <!-- syntak css ini akan memberikan tampilan pada halaman web lebih rapi dan enak ebih cantik-->
  <style>

   /* seting pada body program Sign-up */
    body { 
      padding: 0;
      margin: 0;
    ...
    /* menseting class container */
    .container {
      width: 430px;
      margin: 20px auto;
      position: relative;
    }
    /* menseting class header */
    .container .header {
      font-size: 28px;
      font-weight: bold;
      color: cornsilk;
    ...
    /* menseting tampilan pada label */
    label {
      font-weight: bold;
    }
    /* menseting tampilan pada text 'a' */
    a {
      color: yellow;
      cursor: pointer;
      padding: 10px;
    }
    /* menseting tampilan pada submit*/
    .submit {
      text-align: center;
    }
    /* menseting tampikan pada class success */
    .success{
      color: #40754c;
      padding:10px;
      width:95%;
  ...
  <body>
    ...
    <!-- memberi judul Register -->
      <div class="header">Registrasi</div>
      <form action="No4_conn_signup.php" method="POST">
      ...
      <?php if(isset($_GET['re_password'])){ ?>
        ...
        <div class="singin mt-8 mb-4">
          <small class="teks"
            >Sudah punya akun ?<span><a href="No4_signin.php">Singin sekarang </a></span></small
          >
        </div>
      </form>
    </div>
