<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $queryLogin     = $pdo->query("SELECT * FROM akun WHERE email='$email' AND password='$password' AND status='Aktif'");
        ...
        if ($rowsLogin > 0){
            ...
            echo "<script>alert('Hallo, $_SESSION[email]. Welcome to our website'); window.location = 'dashboard.php'</script>";
