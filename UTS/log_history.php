<?php
$koneksi = mysqli_connect("localhost", "root", "", "sweng2021");
$batasan = 7;
...
$total_halaman = ceil($jumlah_data / $batasan);                           //Syntax untuk membulatkan jumlah page

$tanggal_now = strtotime(date('Y-m-d H:i:s'));
$awal = date('Y-m-d H:i:s', strtotime('-7 day', $tanggal_now));         //Hari sekarang dikurang 7 hari sebelumnya
...
while ($row = mysqli_fetch_assoc($data_log_history)) {
    $result[] = $row;
}
?>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <p><?php echo $result['sign_in_time'] ?></p>
                            </td>
                        </tr>
                    <?php
                    $no++;
