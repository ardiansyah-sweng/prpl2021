...
<body>
    ...
    <form action="halamansignup.php" method="post" encypte="multipart/form-data">
        <td>User Name:</td>
        <br>
        ...
        <center><button type="submit" name="submit" a href="halamanlogin.php">SIGN UP</button></center>
    </form>
</body>
</html>
