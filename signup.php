...
if (isset($_POST['submit'])) {
    ...
    if (!empty($email) and !empty($password) and $panjang_pass) {
        ...
        $sql_insert = "INSERT INTO user VALUES('$id', '$email', '$password')";      
        ...
        if (isset($_POST['submit'])) {
            ...
            $mail->SMTPAuth   = true;                                   
            $mail->Username   = 'abyan29@gmail.com';                     
            $mail->Password   = 'akuganteng11';                              
            $mail->Port       = 587;                                    
            //Recipients
            $mail->setFrom('abyan29@gmail.com', 'Admin');
            $mail->addAddress($email);     //Add a recipient
            $mail->addReplyTo('abyan29@gmail.com', 'Admin');
