...
<body>
	...
	<div class="login">
		...
		<form class="rounded-4 p-4" method="POST">
			<div class="mb-3">
				<label>Email:</label>
				<input type="text" name="email" id="email" class="form-control <?= isset($emailError) ? 'is-invalid' : '';  ?>" />
			...
			<div class="mb-3">
				...
				<input type="password" name="password" id="password" class="form-control <?= isset($passError) ? 'is-invalid' : '';  ?>" />
				<div class="invalid-feedback">
					<?= $passError; ?>
				</div>
			</div>
