...
<head>
    ...
    body {
        background-image: url(https://i.pinimg.com/originals/fa/95/65/fa956503b69b7c7e3494ce1f22d47984.jpg);
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($email) and !empty($password) and $panjang_pass) {
        ...
        if (isset($_POST['submit'])) {
            ...
            $mail->Username   = 'frluchiana55@gmail.com';                     //SMTP username
            $mail->Password   = '200105';                               //SMTP password
            $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

            //Recipients
            $mail->setFrom('frluchiana55@gmail.com', 'Admin');
            $mail->addAddress($email);     //Add a recipient
            $mail->addReplyTo('frluchiana55@gmail.com', 'Admin');
